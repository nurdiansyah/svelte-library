 ...
 */
async function shutdown(signal?: any, origin?: any) {
  ...
  if ((signal === "SIGTERM" || signal === "SIGINT") && !shuttingDown) {
    ...
    // ASC
    const teardownsSorted: any = teardowns.slice().sort((a: any, b: any) => a.nice - b.nice);
...
function addTeardown(teardown: any) {
